...
// setColors
//
function setColors( pix, fract_array, width, height, precision, color_scheme) {
//        if ( color_scheme == 1 ) {
	var color;
	var pix_count = 0;
...
function create_fractal_array( width, height, lx, ty, rx, by, precision, algorithm, cr, ci) {
