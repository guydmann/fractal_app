...
<?php 
	...
	<table width="100%" border="0">
		<tr>
			...
			This page has been tested with Firefox 3.6, Opera 10.5 and Chrome.  The source repository can be found at <a href="http://github.com/guydmann/fractal_app">http://github.com/guydmann/fractal_app<a><br><br>
